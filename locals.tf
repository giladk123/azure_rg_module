locals {
  ...
  subscription_name = "${local.region}-${local.tenant_name}${local.environment}-azus-${local.json_data.subscription_info.subscription_cmdb}-${local.json_data.subscription_info.subscription_freetext}-sb"
